    ...
    <div className="bg-main-color ">
      <div className="container mx-auto px-10 pt-20 lg:px-16 h-full">
        ...
        <div className="flex flex-col xl:flex-row">
          <div className="flex flex-col grow gap-4 [&_img]:w-14 text-white font-bold text-4xl py-8 xl:py-20">
            <a
              href="https://github.com/lipesms"
              className="flex items-center gap-4 p-4  bg-gray-500 rounded-2xl"
            >
              <img src={github} alt="" />
              <p>Github</p>
            </a>
