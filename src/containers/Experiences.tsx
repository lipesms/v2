      ...
      <div className="container mx-auto px-10 lg:px-16 h-full">
        ...
        <div className="[&_button]:text-2xl [&_button]:xl:text-3xl [&_button]:font-bold [&_button]:me-4 py-8 xl:py-20">
          <div className="w-fit m-auto">
            <button className="text-section-active pt-8">Acadêmicas</button>
            <button className="text-white pb-8 xl:pb-24">Profissionais</button>
          </div>
                ...
                return (
                  ...
                  >
                    ...
                    <div className="relative">
                      ...
                      <span
                        className={`block w-px h-full translate-x-[7px] bg-section-active ${index + 1 === experiences.length ? 'hidden' : 'block'}`}
                      ></span>
                    </div>
                    <div></div>
                  </div>
